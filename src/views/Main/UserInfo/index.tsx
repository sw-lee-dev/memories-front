...
import { fileUploadRequest, patchUserReqeust } from 'src/apis';
...
function UserUpdate({onModalViewChange}: UserUpdateProps) {
  ...
  return (
    <div className='user-update-container'>
      ...
      <div className='button primary fullwidth' onClick={onUpdateButtonClickHandler}>수정</div>
    </div>
  )
}
